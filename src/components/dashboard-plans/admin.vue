    ...
    <div class="mt-5 grid xl:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-8">
      <div class="cardin flex rounded-lg drop-shadow-lg">
        <div class="flex items-center justify-around w-full m-5">
          ...
          <div>
            <p class="font-bold text-[13px] text-white">TOTAL NO BANCO</p>
            <p class="text-xs text-gray-400">dados</p>
          </div>
        </div>
      </div>
      <div class="cardin flex rounded-lg drop-shadow-lg">
        <div class="flex items-center justify-around w-full m-5">
          ...
          <div>
            <p class="font-bold text-[13px] text-white">TOTAL NO BANCO</p>
            <p class="text-xs text-gray-400">dados ativos</p>
          </div>
        </div>
      </div>
      <div class="cardin flex rounded-lg drop-shadow-lg">
        <div class="flex items-center justify-around w-full m-5">
          ...
          <div>
            <p class="font-bold text-[13px] text-white">TOTAL NO BANCO</p>
            <p class="text-xs text-gray-400">dados inativos</p>
          </div>
        </div>
      </div>
    </div>
