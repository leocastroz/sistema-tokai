<template>
  <div>
    <div class="flex justify-between items-center">
      <p class="text-xl w-full font-extrabold text-white animate__animated animate__fadeIn">POSTO ROTA - PRODUTOS</p>
...
import { deleteProfessor, getProfessor, addProfessor, editProfessor } from '@/service/postorota/produtosPostoRotaService.js';
import { getMarca } from '@/service/postorota/marcasPostoRotaService.js';
