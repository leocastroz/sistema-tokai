...
const professorImageURL = (professor) => {
  ...
  const empresaVinculo = localStorage.getItem('empresaVinculo');
  const userId = localStorage.getItem('userId');
  console.log('empresaVinculo ->', empresaVinculo);

  if (empresaVinculo == 'undefined') {
    return `${import.meta.env.VITE_AVATAR_URL}${userId}/${professor.fileName}`;
   
  } else {
    return `${import.meta.env.VITE_AVATAR_URL}${empresaVinculo}/${professor.fileName}`;
  }
