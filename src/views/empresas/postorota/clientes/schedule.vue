      ...
      <table class="w-full">
        <thead class="border-solid border-b-[1px] border-[#363636] text-gray-500">
          <tr class="text-xs">
            ...
            <th class="text-left w-64 px-3 ">WHATSAPP</th>
        ...
        <tbody v-if="filteredProfessors.length > 0" class="text-[13px]">
          <tr v-for="professor in paginatedActiveProfessors" :key="professor.id"
            ...
            <td class="text-left animate__animated animate__fadeIn text-white text-justify"><span class=" bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 rounded-xl py-1 px-2">{{ professor.entrada }}</span></td>
            ...
            <td class="animate__animated animate__fadeIn w-80 text-center">
                ...
                <i @click="$emit('delete', professor)"
                  class="fa-solid fa-trash text-[13px] text-white bg-red-500 items-center p-2 mx-1 rounded drop-shadow-md cursor-pointer hover:bg-red-700" v-tooltip="'Deletar'"></i>
                ...
                <!-- <button @click="$emit('venda', professor)">realizar venda</button> -->
